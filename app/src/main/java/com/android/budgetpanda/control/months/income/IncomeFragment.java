package com.android.budgetpanda.control.months.income;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AddItemBottomFragment bottomSheetFragment = AddItemBottomFragment.getInstance(Item.ITEM_CATEGORY.Income);
